...
interface DCIPInterface extends ethers.utils.Interface {
  functions: {
    "ExcludeFromTxLimit(address)": FunctionFragment;
    "IncludeFromTxLimit(address)": FunctionFragment;
    "_communityInvestWalletAddress()": FunctionFragment;
    ...
    "isExcludedFromTxLimit(address)": FunctionFragment;
    "lock(uint256)": FunctionFragment;
    "name()": FunctionFragment;
    "numTokensSellToAddToLiquidity()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "ExcludeFromTxLimit",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "IncludeFromTxLimit",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "_communityInvestWalletAddress",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "isExcludedFromTxLimit",
    values: [string]
  ): string;
...
export class DCIP extends BaseContract {
  ...
  functions: {
    ...
    _communityInvestWalletAddress(overrides?: CallOverrides): Promise<[string]>;
  ...
  numTokensSellToAddToLiquidity(overrides?: CallOverrides): Promise<BigNumber>;
